...
const EXAM_SET_02_DATA = [
  ...
  { id: 5, topic: "ND03: Toán tử", difficulty: "Dễ", question: "Phép tính `10 % -3` trong Python trả về bao nhiêu?", code: "", options: ["1", "-2", "-1", "2"], correctAnswer: 1, explanation: "Python tính `10 // -3 = -4`. Vậy phần dư là `10 - (-3 * -4) = 10 - 12 = -2`.", hint: "Dấu của phép Modulo trong Python phụ thuộc vào mẫu số." },
  { id: 6, topic: "ND03: Định dạng", difficulty: "Dễ", question: "Chuỗi in ra là gì?", code: "print(f'{5:03d}')", options: ["5.000", "005", "500", "  5"], correctAnswer: 1, explanation: "Định dạng `03d` yêu cầu số nguyên (d) chiếm 3 khoảng trống, lấp đầy bằng số 0 ở trước.", hint: "Padding số 0." },
  { id: 7, topic: "ND04: Boolean", difficulty: "Dễ", question: "Kết quả của `True and False or True` là?", code: "", options: ["True", "False", "Error", "None"], correctAnswer: 0, explanation: "`and` ưu tiên cao hơn `or`. `(True and False)` là False. `False or True` là True.", hint: "And tính trước, Or tính sau." },
  { id: 8, topic: "ND04: Falsy", difficulty: "Dễ", question: "Câu lệnh if này in ra gì?", code: "if \"\":\n    print(1)\nelse:\n    print(0)", options: ["1", "0", "Error", "None"], correctAnswer: 1, explanation: "Chuỗi rỗng `\"\"` được đánh giá là False (Falsy). Nhảy vào nhánh else in ra 0.", hint: "Rỗng là Sai." },
  { id: 9, topic: "ND05: Vòng lặp For", difficulty: "Dễ", question: "Tổng các số sinh ra bởi `range(3)` là bao nhiêu?", code: "print(sum(range(3)))", options: ["3", "6", "4", "5"], correctAnswer: 0, explanation: "`range(3)` sinh ra 0, 1, 2. Tổng là 3.", hint: "Cộng dồn các số." },
  { id: 10, topic: "ND05: Câu lệnh pass", difficulty: "Dễ", question: "Lệnh `pass` khác `continue` ở điểm nào?", code: "", options: ["Không khác gì.", "pass là lệnh rỗng giữ chỗ, vòng lặp vẫn chạy tiếp các lệnh dưới nó. continue bỏ qua các lệnh dưới nó.", "pass thoát khỏi vòng lặp.", "pass gây lỗi."], correctAnswer: 1, explanation: "`pass` chỉ lấp chỗ trống cú pháp, trình thông dịch coi như không có gì và chạy thẳng xuống lệnh tiếp theo.", hint: "Pass là tàng hình." },
  { id: 11, topic: "ND06: Args", difficulty: "Dễ", question: "Kiểu dữ liệu của `*args` là gì?", code: "def f(*args):\n    print(type(args))", options: ["list", "tuple", "dict", "set"], correctAnswer: 1, explanation: "`*args` đóng gói tất cả positional arguments thành một Tuple bất biến.", hint: "Tuple." },
  { id: 12, topic: "ND06: Scope", difficulty: "Dễ", question: "Code chạy có lỗi không?", code: "x = 1\ndef f():\n    print(x + 1)\nf()", options: ["Lỗi, vì chưa khai global", "Không lỗi, in ra 2", "In ra 1", "Lỗi NameError"], correctAnswer: 1, explanation: "Chỉ đọc và tính toán (không gán giá trị lại cho x) thì không cần khai báo `global`.", hint: "Chỉ nhìn chứ không chạm." },
  { id: 13, topic: "ND07: Append vs Extend", difficulty: "Dễ", question: "Độ dài mảng sau khi append là bao nhiêu?", code: "l = [1, 2]\nl.append([3, 4])\nprint(len(l))", options: ["4", "3", "2", "Error"], correctAnswer: 1, explanation: "`append` đẩy NGGUYÊN CỤC mảng `[3, 4]` vào làm 1 phần tử duy nhất. Độ dài mảng tăng từ 2 lên 3.", hint: "Nhét nguyên hộp vào mảng." },
  { id: 14, topic: "ND07: Dict get", difficulty: "Dễ", question: "Lệnh `get` này trả về gì?", code: "d = {'a': 1}\nprint(d.get('b', 99))", options: ["Error", "None", "1", "99"], correctAnswer: 3, explanation: "Nếu key không tồn tại, `.get()` trả về giá trị mặc định được cung cấp (99).", hint: "Giá trị dự phòng." },
  { id: 15, topic: "ND08: Insertion Sort", difficulty: "Dễ", question: "Đặc điểm của Insertion Sort là gì?", code: "", options: ["Chia đôi mảng", "Tìm min nhét vào đầu", "Lấy từng phần tử chèn vào đúng vị trí của mảng con đã sắp xếp phía trước", "Hoán đổi kề nhau"], correctAnswer: 2, explanation: "Thuật toán chèn lấy từng thẻ bài và lùi dần để chèn (insert) vào dãy đã xếp trên tay.", hint: "Xếp bài tú lơ khơ." },
  { id: 16, topic: "ND08: Big O", difficulty: "Dễ", question: "Hai vòng lặp lồng nhau duyệt mảng N phần tử có độ phức tạp là?", code: "for i in range(N):\n    for j in range(N):\n        pass", options: ["O(N)", "O(log N)", "O(N^2)", "O(1)"], correctAnswer: 2, explanation: "Lặp N lần, mỗi lần lặp lại N bước con => N * N = O(N^2).", hint: "Nhân lên." },
  { id: 17, topic: "ND09: Kế thừa", difficulty: "Dễ", question: "Kế thừa OOP thể hiện mối quan hệ gì?", code: "", options: ["Has-a (Chứa một)", "Is-a (Là một)", "Uses-a (Dùng một)", "Creates (Tạo ra)"], correctAnswer: 1, explanation: "Kế thừa là quan hệ Is-a (VD: Chó *là một* Động vật).", hint: "Is-a." },
  ...
  { id: 20, topic: "ND12: File Write", difficulty: "Dễ", question: "Chế độ `'w'` làm gì nếu file đã tồn tại?", code: "", options: ["Ghi nối vào cuối", "Báo lỗi", "Xóa trắng file cũ và ghi đè", "Mở file đọc"], correctAnswer: 2, explanation: "Chế độ Write mang tính phá hủy, nó truncate file về 0 bytes trước khi ghi.", hint: "Xóa sạch làm lại." },
  { id: 21, topic: "ND03: Nhân chuỗi", difficulty: "Trung bình", question: "Code in ra gì?", code: "print('A' * 3)", options: ["A3", "Error", "AAA", "3A"], correctAnswer: 2, explanation: "Toán tử nhân `*` trên chuỗi sẽ lặp lại chuỗi đó N lần.", hint: "Nhân bản." },
  { id: 22, topic: "ND03: Slicing mảng", difficulty: "Trung bình", question: "Mảng mới tạo thành là gì?", code: "l = [0, 1, 2, 3, 4]\nprint(l[1:4])", options: ["[1, 2, 3]", "[1, 2, 3, 4]", "[0, 1, 2]", "[2, 3, 4]"], correctAnswer: 0, explanation: "Cắt từ index 1 đến cận index 4 (tức là 1, 2, 3).", hint: "Lấy cận dưới, bỏ cận trên." },
  { id: 23, topic: "ND04: Toán tử 3 ngôi", difficulty: "Trung bình", question: "Giá trị của x là bao nhiêu?", code: "a = 10\nx = 1 if a < 5 else 2", options: ["10", "1", "2", "Error"], correctAnswer: 2, explanation: "Cú pháp `Value_If_True if Condition else Value_If_False`. Do 10 < 5 sai, trả về 2.", hint: "Ternary operator." },
  { id: 24, topic: "ND04: Hàm all()", difficulty: "Trung bình", question: "Hàm `all()` trả về gì?", code: "print(all([True, 1, 'a']))", options: ["False", "True", "Error", "None"], correctAnswer: 1, explanation: "`all()` trả về True nếu TẤT CẢ phần tử trong iterable đều là Truthy. True, 1, 'a' đều Truthy.", hint: "Tất cả đều phải đúng." },
  { id: 25, topic: "ND05: Nested Break", difficulty: "Trung bình", question: "Code in ra chữ gì?", code: "for i in range(2):\n    for j in range(2):\n        break\n        print('A')", options: ["AA", "Không in gì", "A", "AAAA"], correctAnswer: 1, explanation: "Lệnh break chém đứt vòng lặp j ngay lập tức. Lệnh print('A') không bao giờ được chạm tới.", hint: "Break chặn mọi thứ bên dưới." },
  { id: 26, topic: "ND05: Cập nhật While", difficulty: "Trung bình", question: "Để tránh lặp vô hạn, ta cần sửa biến nào?", code: "x = 0\nwhile x < 3:\n    print(x)\n    # Thiếu dòng code", options: ["x += 1", "break", "continue", "pass"], correctAnswer: 0, explanation: "Vòng lặp while cần lệnh cập nhật biến đếm (`x += 1`) để tiến dần tới điều kiện dừng.", hint: "Tiến lên." },
  { id: 27, topic: "ND06: Lệnh Global", difficulty: "Trung bình", question: "Biến x toàn cục biến thành bao nhiêu?", code: "x = 0\ndef update():\n    global x\n    x += 5\nupdate()", options: ["0", "5", "Error", "None"], correctAnswer: 1, explanation: "`global x` cấp quyền ghi cho hàm. `x += 5` đổi biến x ngoài cùng thành 5.", hint: "Sửa đồ của nhà nước." },
  { id: 28, topic: "ND06: Args", difficulty: "Trung bình", question: "Hàm `f()` được gọi bằng cú pháp nào là SAI?", code: "def f(a, b=1): pass", options: ["f(10)", "f(10, 20)", "f(a=10)", "f(b=20)"], correctAnswer: 3, explanation: "Tham số `a` là bắt buộc (không có giá trị mặc định). Lệnh `f(b=20)` thiếu giá trị cho `a` nên báo lỗi.", hint: "Bắt buộc phải điểm danh." },
  { id: 29, topic: "ND07: Comprehension if-else", difficulty: "Trung bình", question: "Mảng sinh ra là?", code: "print([x if x > 0 else 0 for x in [-1, 1]])", options: ["[-1, 1]", "[0, 1]", "[0, 0]", "[1, 1]"], correctAnswer: 1, explanation: "Duyệt -1: do -1 < 0, rơi vào else thành 0. Duyệt 1: 1 > 0, giữ nguyên 1. Mảng là [0, 1].", hint: "Thay số âm bằng 0." },
  { id: 30, topic: "ND07: Set Intersection", difficulty: "Trung bình", question: "Lệnh `&` in ra gì?", code: "print({1,2} & {2,3})", options: ["{1,2,3}", "{2}", "{1,3}", "Error"], correctAnswer: 1, explanation: "Toán tử `&` là phép GIAO, lấy các phần tử chung (số 2).", hint: "Giao điểm." },
  { id: 31, topic: "ND08: Binary Search", difficulty: "Trung bình", question: "Tìm số 5 trong `[1,3,5,7]`. Lần lặp đầu tiên, phần tử `mid` là số mấy?", code: "", options: ["1", "5", "3", "7"], correctAnswer: 2, explanation: "Trục index: L=0, R=3. mid = (0+3)//2 = 1. Giá trị ở index 1 là 3.", hint: "Lấy trung bình cộng index." },
  { id: 32, topic: "ND08: Selection Sort", difficulty: "Trung bình", question: "Bước chính của Selection Sort là gì?", code: "", options: ["Tìm phần tử nhỏ nhất và đổi chỗ nó lên vị trí đầu tiên chưa xếp.", "Chia đôi mảng", "Chèn vào mảng đã xếp", "Trộn mảng"], correctAnswer: 0, explanation: "Selection sort (Sắp xếp chọn) 'chọn' phần tử cực trị (min/max) ở mảng chưa xếp và nhét lên đầu.", hint: "Tuyển chọn người giỏi nhất lên đầu." },
  { id: 33, topic: "ND09: Polymorphism", difficulty: "Trung bình", question: "Việc 2 lớp con có cùng 1 tên hàm `speak()` nhưng thực thi khác nhau gọi là tính chất gì?", code: "", options: ["Đóng gói", "Đa hình (Polymorphism)", "Kế thừa", "Trừu tượng"], correctAnswer: 1, explanation: "Đa hình cho phép đối tượng thuộc các lớp khác nhau phản hồi lại cùng một lời gọi hàm theo những cách riêng biệt.", hint: "Nhiều hình thái." },
  { id: 34, topic: "ND09: Abstract Class", difficulty: "Trung bình", question: "Lớp trừu tượng (Abstract class) trong Python thừa kế từ module nào?", code: "", options: ["sys", "abc (ABC, abstractmethod)", "os", "math"], correctAnswer: 1, explanation: "Thư viện `abc` (Abstract Base Classes) dùng để tạo khuôn mẫu bắt buộc lớp con phải ghi đè hàm.", hint: "A-B-C." },
  ...
  { id: 36, topic: "ND10: Tháp Hà Nội", difficulty: "Trung bình", question: "Độ phức tạp thời gian giải bài toán Tháp Hà Nội bằng đệ quy là?", code: "", options: ["O(N)", "O(N log N)", "O(2^N)", "O(N^2)"], correctAnswer: 2, explanation: "Công thức truy hồi T(N) = 2T(N-1) + 1 sinh ra độ phức tạp hàm mũ O(2^N).", hint: "Hàm mũ gấp đôi mỗi bước." },
  { id: 37, topic: "ND11: try-else", difficulty: "Trung bình", question: "Khối `else` chạy khi nào?", code: "try:\n    x = 1\nexcept:\n    pass\nelse:\n    print('A')", options: ["Luôn chạy", "Chạy khi có lỗi", "Chạy khi khối try KHÔNG tung ra lỗi nào", "Lỗi cú pháp"], correctAnswer: 2, explanation: "Else chạy nếu try kết thúc hoàn hảo, bình yên vô sự.", hint: "Bình yên vô sự." },
  { id: 38, topic: "ND12: seek(0)", difficulty: "Trung bình", question: "Lệnh `f.seek(0)` làm gì?", code: "", options: ["Xóa file", "Chuyển con trỏ về đầu file (byte 0)", "Xóa dòng 0", "Tắt file"], correctAnswer: 1, explanation: "Seek(0) tua lại băng cát sét về điểm xuất phát để đọc lại từ đầu.", hint: "Tua lại (Rewind)." },
  { id: 39, topic: "Nâng cao: Assert", difficulty: "Trung bình", question: "Ngoại lệ nào bị ném ra nếu điều kiện `assert` bị sai?", code: "assert 1 == 2", options: ["ValueError", "SyntaxError", "AssertionError", "TypeError"], correctAnswer: 2, explanation: "Lệnh assert ném ra AssertionError để báo hiệu giả định của lập trình viên đã bị vi phạm.", hint: "Assertion." },
  { id: 40, topic: "Nâng cao: deque", difficulty: "Trung bình", question: "Lệnh `appendleft(1)` thực hiện chèn số 1 vào vị trí nào của Deque?", code: "", options: ["Giữa mảng", "Cuối mảng", "Đầu mảng (Bên trái)", "Thay thế phần tử đầu"], correctAnswer: 2, explanation: "Chèn vào ngay vị trí index 0 với độ phức tạp O(1) mà không cần xê dịch các phần tử khác.", hint: "Left = Trái/Đầu." },
  { id: 41, topic: "ND07: Identity List", difficulty: "Khó", question: "So sánh identity này in ra gì?", code: "a = []\nb = []\nprint(a == b, a is b)", options: ["True True", "False False", "True False", "False True"], correctAnswer: 2, explanation: "`==` so sánh giá trị (đều là rỗng -> True). `is` so sánh địa chỉ bộ nhớ. Python cấp phát vùng nhớ độc lập cho mỗi list rỗng -> False.", hint: "List luôn tạo vùng nhớ mới." },
  { id: 42, topic: "ND04: Chain comparison trap", difficulty: "Khó", question: "In ra giá trị gì?", code: "print(1 < 3 < 2 == False)", options: ["True", "False", "Error", "None"], correctAnswer: 1, explanation: "Dịch thành `(1 < 3) and (3 < 2) and (2 == False)`. Chỗ `(3 < 2)` là False, nên cả biểu thức là False.", hint: "Chuỗi toán tử bẻ gãy bằng các chữ AND." },
...
const EXAM_SET_04_DATA = [
  ...
  { id: 20, topic: "ND12: Đọc file", difficulty: "Dễ", question: "Phương thức `.read()` trên đối tượng file trả về cái gì?", code: "f.read()", options: ["Một danh sách các chuỗi.", "Một chuỗi (String) duy nhất chứa toàn bộ nội dung file.", "Số lượng byte trong file.", "Một đối tượng JSON."], correctAnswer: 1, explanation: "Hàm `.read()` hút toàn bộ nội dung của tệp tin vào RAM và trả về dưới dạng một chuỗi văn bản dài.", hint: "Đọc nguyên khối." },
  { id: 21, topic: "ND03: Biểu thức", difficulty: "Trung bình", question: "Kết quả in ra là gì?", code: "print(16 // 3 + 16 % 3)", options: ["5", "6", "1", "16"], correctAnswer: 1, explanation: "`16 // 3 = 5`. `16 % 3 = 1`. Tổng `5 + 1 = 6`.", hint: "Lấy nguyên cộng lấy dư." },
  { id: 22, topic: "ND03: Slicing", difficulty: "Trung bình", question: "Đoạn cắt lát này lấy phần nào của chuỗi?", code: "s = 'PYTHON'\nprint(s[-3:])", options: ["HON", "PYT", "N", "THO"], correctAnswer: 0, explanation: "Cắt từ chỉ mục -3 (chữ H đếm ngược từ đuôi) cho đến hết chuỗi, thu được 'HON'.", hint: "-3 là đếm ngược 3 ký tự từ cuối." },
  { id: 23, topic: "ND04: Short-circuit", difficulty: "Trung bình", question: "Code có văng lỗi chia cho 0 không?", code: "x = True or (1 / 0)\nprint(x)", options: ["Có lỗi ZeroDivisionError", "Không, in ra True", "In ra False", "In ra 1"], correctAnswer: 1, explanation: "Toán tử `or` có tính chất đoản mạch. Vế trái `True` đã đủ làm toàn biểu thức `True`, vế phải `(1/0)` bị bỏ qua không tính đến.", hint: "Or chỉ cần 1 vế True là bỏ qua vế sau." },
  { id: 24, topic: "ND04: So sánh", difficulty: "Trung bình", question: "Biểu thức này trả về gì?", code: "print(5 == 5.0)", options: ["False", "True", "Error", "None"], correctAnswer: 1, explanation: "Toán tử `==` so sánh giá trị toán học. Số nguyên 5 và số thực 5.0 có cùng giá trị nên trả về True.", hint: "So sánh giá trị toán học." },
  { id: 25, topic: "ND05: Vòng lặp For-else", difficulty: "Trung bình", question: "Dòng chữ 'A' có được in ra không?", code: "for i in range(3):\n    break\nelse:\n    print('A')", options: ["Có", "Không, vì vòng lặp bị break", "In ra 3 lần", "Lỗi cú pháp"], correctAnswer: 1, explanation: "Khối `else` của vòng lặp chỉ chạy nếu vòng lặp kết thúc tự nhiên mà không đụng phải lệnh `break`.", hint: "Else có nghĩa là 'Không bị break'." },
  { id: 26, topic: "ND05: Vòng lặp While", difficulty: "Trung bình", question: "Vòng lặp in ra những số nào?", code: "i = 0\nwhile i < 3:\n    i += 2\n    print(i, end=' ')", options: ["0 2", "2 4", "2", "0 2 4"], correctAnswer: 1, explanation: "Lần lặp 1: `i=0 -> i=2`, in 2. Lần lặp 2: Điều kiện `2<3` đúng, `i=2 -> i=4`, in 4. Điều kiện `4<3` sai, dừng vòng lặp.", hint: "Chú ý vị trí lệnh print." },
  { id: 27, topic: "ND06: Lệnh Global", difficulty: "Trung bình", question: "Code in ra gì?", code: "x = 1\ndef f():\n    global x\n    x = 5\nf()\nprint(x)", options: ["1", "5", "Error", "None"], correctAnswer: 1, explanation: "Từ khóa `global x` cho phép hàm sửa đổi trực tiếp biến `x` ở bên ngoài. Giá trị x cập nhật thành 5.", hint: "Sửa đổi biến ngoài." },
  { id: 28, topic: "ND06: Unpack args", difficulty: "Trung bình", question: "Giá trị in ra là bao nhiêu?", code: "def f(*args):\n    print(args[1])\nf(10, 20, 30)", options: ["10", "20", "30", "Error"], correctAnswer: 1, explanation: "`*args` nhận vào một Tuple `(10, 20, 30)`. Phần tử ở chỉ mục 1 là 20.", hint: "Chỉ mục (index) đếm từ 0." },
  { id: 29, topic: "ND07: Set", difficulty: "Trung bình", question: "Đoạn code in ra gì?", code: "print(set([1, 2, 2, 3]))", options: ["[1, 2, 3]", "{1, 2, 3}", "Error", "{1, 2, 2, 3}"], correctAnswer: 1, explanation: "Hàm `set()` loại bỏ các phần tử trùng lặp của List và trả về một tập hợp (có ngoặc nhọn).", hint: "Set dùng ngoặc nhọn và không có phần tử trùng." },
  { id: 30, topic: "ND07: Shallow Copy", difficulty: "Trung bình", question: "Bản sao nông (Shallow copy) thể hiện thế nào ở đây?", code: "a = [1, 2]\nb = a.copy()\na[0] = 9\nprint(b[0])", options: ["1", "9", "Error", "2"], correctAnswer: 0, explanation: "Hàm `.copy()` tạo ra một bản sao mới (cho danh sách 1 chiều). Sửa mảng `a` không làm ảnh hưởng đến mảng `b`. `b[0]` vẫn là 1.", hint: "Copy tạo ra mảng mới (với dữ liệu 1 chiều)." },
  { id: 31, topic: "ND08: Tìm kiếm Nhị phân", difficulty: "Trung bình", question: "Trong Tìm kiếm nhị phân trên mảng `[1, 2, 3, 4]`, phần tử `mid` đầu tiên là gì?", code: "", options: ["1", "2", "3", "4"], correctAnswer: 1, explanation: "Chỉ mục `left=0`, `right=3`. Tính `mid = (0 + 3) // 2 = 1`. Giá trị tại index 1 là 2.", hint: "Lấy trung bình cộng index." },
...
const EXAM_SET_05_DATA = [
  ...
  { id: 5, topic: "ND03: Phép toán", difficulty: "Dễ", question: "Kết quả của lệnh in sau là gì?", code: "print(14 % -3)", options: ["2", "-1", "-2", "1"], correctAnswer: 1, explanation: "Trong Python, dấu của phép Modulo `%` luôn đi theo dấu của mẫu số. `14 // -3 = -5`. Suy ra `14 - (-3 * -5) = 14 - 15 = -1`.", hint: "Dấu của số bị chia." },
  { id: 6, topic: "ND03: Định dạng chuỗi", difficulty: "Dễ", question: "Đoạn code f-string này in ra chuỗi nào?", code: "x = 10\nprint(f'{x:04d}')", options: ["1000", "0010", "10", "0001"], correctAnswer: 1, explanation: "Định dạng `04d` yêu cầu số nguyên (d) phải chiếm đúng 4 ký tự, nếu thiếu thì chèn các số 0 vào phía trước (Padding).", hint: "Chèn số 0 cho đủ độ dài." },
  { id: 7, topic: "ND04: Falsy string", difficulty: "Dễ", question: "Biến `b` sẽ mang giá trị Boolean nào?", code: "s = ' '\nb = bool(s)\nprint(b)", options: ["False", "True", "None", "Error"], correctAnswer: 1, explanation: "Chuỗi `s` chứa một ký tự khoảng trắng (Space), KHÔNG PHẢI LÀ CHUỖI RỖNG `''`. Do đó nó là Truthy (True).", hint: "Khoảng trắng cũng là một ký tự." },
  { id: 8, topic: "ND04: Điều kiện if", difficulty: "Dễ", question: "Chương trình sẽ in ra số mấy?", code: "if {}:\n    print(1)\nelse:\n    print(0)", options: ["1", "0", "Lỗi cú pháp", "Không in gì"], correctAnswer: 1, explanation: "Một Dictionary rỗng `{}` được đánh giá là Falsy (Sai). Chương trình sẽ nhảy vào nhánh else in ra 0.", hint: "Hộp không có gì bên trong." },
  { id: 9, topic: "ND05: Vòng lặp For", difficulty: "Dễ", question: "Hàm `range(2, 6, 2)` sinh ra những số nào?", code: "", options: ["2, 3, 4, 5", "2, 4, 6", "2, 4", "0, 2, 4"], correctAnswer: 2, explanation: "Bắt đầu từ 2, nhảy 2 bước, dừng trước 6. Kết quả là 2 và 4.", hint: "Nhảy cóc 2 bước." },
  { id: 10, topic: "ND05: Pass statement", difficulty: "Dễ", question: "Lệnh `pass` khác gì với `continue`?", code: "", options: ["Chúng giống hệt nhau.", "`pass` không làm gì cả và chạy tiếp các lệnh dưới nó. `continue` bỏ qua các lệnh dưới nó để lặp vòng mới.", "`pass` gây lỗi nếu đứng một mình.", "`pass` dùng để đóng file."], correctAnswer: 1, explanation: "`pass` chỉ là lệnh giữ chỗ để lấp đầy khối lệnh rỗng, nó hoàn toàn vô hại và không can thiệp vào luồng chạy.", hint: "Tàng hình." },
  ...
  { id: 20, topic: "ND12: File mode", difficulty: "Dễ", question: "Chế độ `'a'` trong hàm mở file `open('file.txt', 'a')` có tác dụng gì?", code: "", options: ["Chỉ đọc file.", "Xóa trắng file rồi mới ghi.", "Ghi nối dữ liệu mới vào cuối nội dung file đã có (Append).", "Đổi tên file."], correctAnswer: 2, explanation: "Chế độ 'a' (Append) cho phép thêm dữ liệu mà không làm mất đi những nội dung trước đó của tệp tin.", hint: "Nối đuôi." },
  { id: 21, topic: "ND03: Precedence", difficulty: "Trung bình", question: "Luồng chạy của biểu thức sau in ra số mấy?", code: "print(2 ** 3 ** 2)", options: ["64", "512", "72", "12"], correctAnswer: 1, explanation: "Toán tử mũ `**` có tính kết hợp từ PHẢI SANG TRÁI. Nó tính `3**2 = 9`, sau đó `2**9 = 512`.", hint: "Tính phần đuôi trước." },
  { id: 22, topic: "ND03: Slicing mảng", difficulty: "Trung bình", question: "Cắt lát chuỗi này in ra kết quả gì?", code: "s = 'ABCDEFG'\nprint(s[1:5:2])", options: ["BDF", "BD", "ACE", "BCDE"], correctAnswer: 1, explanation: "Bắt đầu từ index 1 ('B'), dừng trước index 5 ('F'), bước nhảy 2. Lấy được index 1 ('B'), index 3 ('D'). Kết quả 'BD'.", hint: "Bước nhảy là 2." },
  { id: 23, topic: "ND04: Toán tử and", difficulty: "Trung bình", question: "Biến x lưu trữ giá trị gì?", code: "x = 5 and 10\nprint(x)", options: ["True", "False", "5", "10"], correctAnswer: 3, explanation: "Toán tử `and` trả về phần tử Truthy cuối cùng nó đánh giá. Vì 5 là True, nó đánh giá tiếp 10 và trả về 10.", hint: "And cần duyệt đến tận cùng nếu mọi thứ đều đúng." },
  { id: 24, topic: "ND04: Chain Comparison", difficulty: "Trung bình", question: "Đoạn so sánh chuỗi này trả về True hay False?", code: "print(3 > 2 == 2)", options: ["True", "False", "Error", "None"], correctAnswer: 0, explanation: "Python bẻ thành `(3 > 2) and (2 == 2)`. Cả 2 đều True. Kết quả True.", hint: "Thêm chữ AND vào giữa." },
  { id: 25, topic: "ND05: for-else", difficulty: "Trung bình", question: "Vòng lặp này có in ra chữ 'Else' không?", code: "for i in range(2):\n    pass\nelse:\n    print('Else')", options: ["Có", "Không", "Error", "In ra 2 lần"], correctAnswer: 0, explanation: "Khối `else` đính kèm vòng lặp sẽ thi hành nếu vòng lặp kết thúc tự nhiên (không bị break). Do chỉ có pass, vòng lặp kết thúc tốt đẹp và in ra 'Else'.", hint: "Else = Vòng lặp an toàn." },
  { id: 26, topic: "ND05: Nested break", difficulty: "Trung bình", question: "Lệnh break ảnh hưởng thế nào?", code: "for i in range(2):\n    for j in range(2):\n        break\n    print('X')", options: ["Chương trình kết thúc ngay.", "In ra 2 chữ 'X'.", "In ra 1 chữ 'X'.", "Không in gì."], correctAnswer: 1, explanation: "Lệnh `break` chỉ đập vỡ được 1 vòng lặp chứa nó trực tiếp (vòng lặp j). Vòng lặp `i` vẫn chạy 2 lần và in ra 2 chữ 'X'.", hint: "Break chỉ phá được 1 bức tường." },
  { id: 27, topic: "ND06: Lệnh Global", difficulty: "Trung bình", question: "Hàm này sửa đổi biến toàn cục như thế nào?", code: "y = 10\ndef modify():\n    global y\n    y = y + 5\nmodify()\nprint(y)", options: ["10", "15", "Error", "None"], correctAnswer: 1, explanation: "`global y` cho phép hàm tham chiếu và GHI ĐÈ lên biến `y` ngoài cùng. `y` tăng thêm 5 thành 15.", hint: "Sửa tận gốc." },
  { id: 28, topic: "ND06: Unpack function", difficulty: "Trung bình", question: "Toán tử `*` làm gì ở đây?", code: "def add(a, b, c):\n    print(a+b+c)\nadd(*[1, 2, 3])", options: ["Nhân 3 số", "Gây lỗi", "Bung mảng [1,2,3] thành 3 đối số độc lập truyền vào hàm", "In ra mảng"], correctAnswer: 2, explanation: "Dấu `*` đứng trước List khi gọi hàm sẽ bung (unpack) List đó ra thành các phần tử riêng lẻ nạp vào tham số `a, b, c`. Kết quả là 6.", hint: "Mở gói hàng." },
  { id: 29, topic: "ND07: Set Union", difficulty: "Trung bình", question: "Toán tử `|` giữa 2 Set trả về gì?", code: "print(set([1, 1, 2]) | set([2, 3]))", options: ["{1, 2, 3}", "{2}", "{1, 3}", "Error"], correctAnswer: 0, explanation: "Toán tử `|` là phép HỢP (Union). Gộp chung `{1, 2}` và `{2, 3}` thành `{1, 2, 3}`.", hint: "Gom hết tài sản." },
  { id: 30, topic: "ND07: List Comprehension", difficulty: "Trung bình", question: "Mảng sinh ra là?", code: "print([x*2 for x in [1, 2, 3] if x < 3])", options: ["[2, 4, 6]", "[2, 4]", "[4, 6]", "[]"], correctAnswer: 1, explanation: "Lọc `x < 3` giữ lại 1 và 2. Biểu thức `x*2` biến chúng thành 2 và 4.", hint: "Lọc trước, tính sau." },
  { id: 31, topic: "ND08: Tìm kiếm nhị phân", difficulty: "Trung bình", question: "Trong Tìm kiếm nhị phân trên mảng 6 phần tử `L=0, R=5`. Chỉ mục `mid` đầu tiên là?", code: "", options: ["3", "2.5", "2", "4"], correctAnswer: 2, explanation: "`mid = (L + R) // 2`. Do `(0 + 5) // 2 = 2`. Chỉ mục mid đầu tiên là 2.", hint: "Lấy phần nguyên." },
...
const EXAM_SET_06_DATA = [
  ...
  { id: 5, topic: "ND03: Phép chia", difficulty: "Dễ", question: "Kết quả in ra của phép chia lấy nguyên này là gì?", code: "print(10 // -3)", options: ["-3", "-4", "-3.33", "3"], correctAnswer: 1, explanation: "Phép `//` (floor division) luôn làm tròn XUỐNG số nguyên nhỏ hơn. `10 / -3 = -3.33`, làm tròn xuống là -4.", hint: "Làm tròn xuống giá trị nhỏ hơn." },
  { id: 6, topic: "ND03: Padding chuỗi", difficulty: "Dễ", question: "Cú pháp định dạng này sẽ in ra kết quả nào?", code: "print(f'{7:04d}')", options: ["7000", "0007", "7.000", "  07"], correctAnswer: 1, explanation: "Định dạng `04d` yêu cầu in số nguyên chiếm 4 ký tự, điền thêm các số 0 vào khoảng trống bên trái.", hint: "Điền số 0 cho đủ 4 ô." },
  { id: 7, topic: "ND04: Toán tử Boolean", difficulty: "Dễ", question: "Kết quả của biểu thức `not (True or False)` là?", code: "", options: ["True", "False", "None", "Lỗi"], correctAnswer: 1, explanation: "`True or False` là True. Phủ định `not True` là False.", hint: "Tính trong ngoặc trước." },
  { id: 8, topic: "ND04: Falsy Value", difficulty: "Dễ", question: "Điều kiện `if` này đánh giá chuỗi là Đúng hay Sai?", code: "if ' ':\n    print('A')\nelse:\n    print('B')", options: ["A", "B", "Lỗi", "None"], correctAnswer: 0, explanation: "Chuỗi chứa khoảng trắng `' '` là một chuỗi có nội dung (khác rỗng), do đó nó mang giá trị Truthy.", hint: "Khoảng trắng cũng là ký tự." },
  { id: 9, topic: "ND05: Vòng lặp For", difficulty: "Dễ", question: "Hàm `range(5, 1, -2)` sẽ sinh ra các số nào?", code: "", options: ["5, 3, 1", "5, 4, 3, 2", "5, 3", "Lỗi"], correctAnswer: 2, explanation: "Bắt đầu từ 5, giảm đi 2 mỗi bước (5, 3). Dừng ngay trước số 1. Kết quả là 5, 3.", hint: "Chạm cận trên là dừng." },
  { id: 10, topic: "ND05: Pass vs Continue", difficulty: "Dễ", question: "Lệnh `pass` trong Python có ý nghĩa gì?", code: "", options: ["Thoát vòng lặp.", "Bỏ qua lần lặp hiện tại.", "Là một câu lệnh rỗng, không làm gì cả, chỉ để lấp đầy khối lệnh cho đúng cú pháp.", "Gây ra lỗi chạy chương trình."], correctAnswer: 2, explanation: "`pass` không cản trở hay thay đổi luồng chạy của code, nó chỉ là placeholder.", hint: "Lệnh tàng hình." },
  { id: 11, topic: "ND06: Khai báo hàm", difficulty: "Dễ", question: "Lỗi sai trong dòng khai báo hàm này là gì?", code: "def add(a=0, b): return a + b", options: ["Thiếu dấu ngoặc.", "Không được return phép cộng.", "Tham số mặc định (a=0) không được đặt trước tham số bắt buộc (b).", "Không có lỗi."], correctAnswer: 2, explanation: "Python bắt buộc mọi tham số có giá trị mặc định phải nằm ở phía sau (cuối danh sách) các tham số thông thường.", hint: "Ai có ô thì xếp hàng sau." },
  { id: 12, topic: "ND06: Args", difficulty: "Dễ", question: "Tham số `*args` đóng gói các phần tử truyền vào dưới dạng cấu trúc gì?", code: "def f(*args): pass", options: ["List", "Dictionary", "Tuple", "Set"], correctAnswer: 2, explanation: "`*args` nhận vô số các tham số vị trí và gói gọn chúng vào một đối tượng Tuple (bất biến).", hint: "Ngoặc đơn bất biến." },
  { id: 13, topic: "ND07: Tuple vs List", difficulty: "Dễ", question: "Khác biệt cốt lõi nhất giữa Tuple và List là gì?", code: "", options: ["Tuple chạy chậm hơn.", "Tuple không chứa được chuỗi.", "Tuple có tính bất biến (Immutable), List thì khả biến (Mutable).", "Tuple tốn nhiều RAM hơn."], correctAnswer: 2, explanation: "Tuple một khi khởi tạo sẽ bị khóa cứng, không thể thêm/sửa/xóa phần tử.", hint: "Sự thay đổi." },
  { id: 14, topic: "ND07: Set Elements", difficulty: "Dễ", question: "Phần tử nào sau đây KHÔNG THỂ được thêm vào một tập hợp (Set)?", code: "", options: ["100", "'Hello'", "(1, 2)", "[1, 2]"], correctAnswer: 3, explanation: "Set yêu cầu phần tử phải bất biến (Hashable). List `[1, 2]` là khả biến nên không có mã hash cố định.", hint: "Set không chứa vật thể thay đổi hình dạng." },
  { id: 15, topic: "ND08: Bubble Sort", difficulty: "Dễ", question: "Sắp xếp nổi bọt (Bubble Sort) hoạt động dựa trên cơ chế nào?", code: "", options: ["Tìm phần tử nhỏ nhất và chèn lên đầu.", "Chia đôi mảng liên tục.", "Liên tục so sánh và hoán đổi vị trí của các cặp phần tử liền kề nhau.", "Chọn phần tử ngẫu nhiên làm chốt."], correctAnswer: 2, explanation: "Bubble sort quét qua mảng và đổi chỗ (swap) 2 phần tử cạnh nhau nếu chúng ngược thứ tự.", hint: "Hoán đổi lân cận." },
  { id: 16, topic: "ND08: Binary Search", difficulty: "Dễ", question: "Điều kiện tiên quyết để thuật toán Tìm kiếm Nhị phân hoạt động đúng là gì?", code: "", options: ["Mảng phải chứa toàn số dương.", "Mảng PHẢI ĐƯỢC SẮP XẾP từ trước.", "Mảng không có phần tử trùng lặp.", "Mảng phải có độ dài chẵn."], correctAnswer: 1, explanation: "Binary search dựa vào tính thứ tự của dữ liệu để loại bỏ một nửa không gian tìm kiếm ở mỗi bước.", hint: "Có thứ tự mới chặt đôi được." },
...
const EXAM_SETS = [
  {
    id: "SET_01",
    title: "Bộ Đề 01: Nền Tảng Trace Code",
    description: "Ngân hàng 50 câu hỏi truy xuất luồng chạy, tập trung vào vòng lặp, scope, list dict và OOP cơ bản.",
    questionCount: EXAM_SET_01_DATA.length,
    data: EXAM_SET_01_DATA
  },
  {
    id: "SET_02",
    title: "Bộ Đề 02: Cạm Bẫy Trình Thông Dịch",
    description: "Đi sâu vào Identity `is/==`, bẫy Mutable Defaults, Generator, MRO và K-Means.",
    questionCount: EXAM_SET_02_DATA.length,
    data: EXAM_SET_02_DATA
  },
  {
    id: "SET_03",
    title: "Bộ Đề 03: Tư Duy Logic Cốt Lõi",
    description: "Khai thác De Morgan, Slicing nâng cao, Late vs Early Binding, Dead Exception và IEEE 754.",
    questionCount: EXAM_SET_03_DATA.length,
    data: EXAM_SET_03_DATA
  },
  {
    id: "SET_04",
    title: "Bộ Đề 04: Lốc Xoáy Bẫy Vùng Nhớ",
    description: "Xoáy sâu vào rò rỉ biến (Loop leak), mảng 2 chiều nhân bản, và toán tử đoản mạch hiểm hóc.",
    questionCount: EXAM_SET_04_DATA.length,
    data: EXAM_SET_04_DATA
  },
  {
    id: "SET_05",
    title: "Bộ Đề 05: Tuyệt Đỉnh Phân Tích",
    description: "Khám phá ảo thuật Boolean (`True+2`), List Comprehension filter, File EOF và Class Scope.",
    questionCount: EXAM_SET_05_DATA.length,
    data: EXAM_SET_05_DATA
  },
  {
    id: "SET_06",
    title: "Bộ Đề 06: Trùm Cuối Sinh Tử (MỚI)",
    description: "50 câu hỏi tinh hoa. Kiểm tra Float Precision, MRO phức tạp, và cạm bẫy Assert Tuple. (Tỷ lệ: 40% Dễ - 40% TB - 20% Khó).",
    questionCount: EXAM_SET_06_DATA.length,
    data: EXAM_SET_06_DATA
  }
];
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-zinc-950/60 border border-zinc-800 rounded-2xl p-5 space-y-4 shadow-lg">
            ...
            <div className="flex justify-between items-center text-xs text-zinc-400">
              <span>Tiến độ</span>
              <span>{currentQuestionIdx + 1}/{questionsBank.length} Câu hỏi</span>
            </div>

            <div className="grid grid-cols-5 gap-2 pt-2 overflow-y-auto max-h-[300px] pr-1 scrollbar-thin scrollbar-thumb-zinc-800">
              {questionsBank.map((q, idx) => {
                ...
                if (qState) {
                  if (mockActive) {
                    btnStyle = "bg-sky-600/30 border-sky-500 text-sky-400";
                  } else {
                ...
                if (idx === currentQuestionIdx) {
                  btnStyle += " ring-2 ring-sky-500 ring-offset-2 ring-offset-[#09090b]";
                }
            ...
            <div className="pt-4 border-t border-zinc-900 grid grid-cols-2 gap-2 text-[10px] text-zinc-400">
              ...
              <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-sky-500" /><span>Đã chọn</span></div>
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-6 sm:p-8 space-y-6 relative shadow-lg">
            <div className="flex items-center justify-between text-xs">
              <div className="flex items-center gap-3">
                <span className="bg-sky-500/10 text-sky-400 border border-sky-500/20 px-3 py-1 rounded-full font-bold truncate max-w-[200px] sm:max-w-none">
                  {question.topic}
                </span>
                <span className={`px-2.5 py-0.5 rounded-md font-semibold ${
                  question.difficulty === 'Khó' ? 'bg-rose-500/10 text-rose-400' : 
                  question.difficulty === 'Trung bình' ? 'bg-amber-500/10 text-amber-400' : 
            ...
            <div className="space-y-4">
              ...
              {question.code && (
                <div className="rounded-2xl border border-zinc-800 bg-[#040405] p-5 font-mono text-xs sm:text-sm text-sky-300 overflow-x-auto shadow-inner whitespace-pre">
                  {question.code}
                </div>
              )}
            </div>
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-start">
                ...
                {activeTab !== 'mock' && !isAnswerSubmitted && (
                  <button 
                    ...
                    className="text-xs font-bold text-sky-400 hover:text-sky-300 py-2 px-4 rounded-lg bg-sky-500/5 hover:bg-sky-500/10 transition-colors"
                  >
              ...
              <div className="w-full sm:w-auto flex justify-end">
                {mockActive ? (
                  <button
                    ...
                    className="w-full sm:w-auto bg-zinc-100 hover:bg-white text-zinc-950 font-bold px-6 py-3 rounded-xl transition-all text-xs tracking-wider uppercase flex items-center justify-center gap-2"
                  >
                    {currentQuestionIdx === questionsBank.length - 1 ? 'Xem toàn bộ sơ đồ' : 'Câu tiếp theo'}
                    <Icons.Next />
                  </button>
                ) : (
                  !isAnswerSubmitted ? (
                    <button
                      ...
                      className="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:hover:bg-emerald-500 text-zinc-950 font-bold px-8 py-3 rounded-xl transition-all text-xs tracking-wider uppercase"
                    >
                      Xác Nhận Đáp Án
                    </button>
                  ) : (
                    <button
                      onClick={nextQuestion}
                      className="w-full sm:w-auto bg-zinc-100 hover:bg-white text-zinc-950 font-bold px-8 py-3 rounded-xl transition-all text-xs tracking-wider uppercase flex items-center justify-center gap-2"
                    >
            ...
            {showHint && question.hint && (
              <div className="p-4 bg-sky-950/20 border border-sky-900/50 rounded-xl text-xs text-sky-400 flex gap-2.5">
                <Icons.Info />
              ...
              <div className="mt-6 pt-6 border-t border-zinc-800 space-y-4 animate-slideUp">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs mt-0.5">Phân tích logic lập trình Python</p>
                  </div>
                </div>
      ...
      <header className="border-b border-zinc-800 bg-[#09090b]/80 backdrop-blur sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => { setActiveTab('home'); setIsTimerRunning(false); setMockActive(false); }}>
            ...
            <div>
              <h1 className="font-bold text-zinc-50 tracking-wide text-sm sm:text-base">COM1050 - Galaxy Engine</h1>
              <p className="text-xs text-emerald-400 font-mono">v9.0 Cosmic Packs</p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {EXAM_SETS.map((exam) => (
                  <div key={exam.id} className="bg-zinc-950/60 border border-zinc-800 rounded-3xl p-6 hover:border-emerald-500/40 transition-colors group flex flex-col shadow-lg shadow-black">
                    ...
                    <p className="text-sm text-zinc-500 mb-6 flex-1 leading-relaxed line-clamp-3">{exam.description}</p>
                    <div className="flex flex-col xl:flex-row gap-3 mt-auto pt-4 border-t border-zinc-800/50">
                      <button 
          ...
          <div className="space-y-8 max-w-4xl mx-auto animate-slideUp">
            <div className="relative rounded-3xl overflow-hidden border border-zinc-800 bg-gradient-to-b from-zinc-950 to-zinc-900 p-8 sm:p-12 text-center shadow-2xl">
              ...
              <div className="max-w-md mx-auto space-y-6">
                ...
                <div className="space-y-2">
                  <h2 className="text-3xl font-black text-white">Luyện tập Hoàn Tất!</h2>
                  <p className="text-zinc-400 text-sm">Hệ thống đã ghi nhận toàn bộ kết quả của bạn cho {currentExam?.title}.</p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 py-4">
                  <div className="bg-zinc-900/50 border border-zinc-800/80 p-4 rounded-2xl">
                    ...
                    <span className="text-[10px] sm:text-xs text-zinc-500 uppercase tracking-wider font-semibold">Chính xác</span>
                  </div>
                  <div className="bg-zinc-900/50 border border-zinc-800/80 p-4 rounded-2xl">
                    <span className="block text-2xl font-black text-rose-400 font-mono">{resultsMetrics.wrong}</span>
                    <span className="text-[10px] sm:text-xs text-zinc-500 uppercase tracking-wider font-semibold">Bị Sai</span>
                  </div>
                  <div className="bg-zinc-900/50 border border-zinc-800/80 p-4 rounded-2xl">
                    <span className="block text-2xl font-black text-sky-400 font-mono">{scoreXP}</span>
                    <span className="text-[10px] sm:text-xs text-zinc-500 uppercase tracking-wider font-semibold">XP Tích lũy</span>
                  </div>
                </div>

                <div className="bg-zinc-900/20 border border-zinc-800/60 p-4 rounded-xl text-xs flex justify-between text-zinc-400">
                  ...
                  return (
                    <div key={idx} className="space-y-2">
                      <div className="flex items-center justify-between text-xs sm:text-sm">
                        <span className="font-bold text-zinc-300 truncate max-w-[250px] block" title={topic}>{topic}</span>
                        <span className="font-semibold text-zinc-400 shrink-0">{stats.correct}/{stats.total} ({percent}%)</span>
                      </div>
            ...
            <div className="flex justify-center gap-4">
              <button 
                ...
                className="bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold px-6 py-3 rounded-xl transition-all shadow-lg shadow-emerald-500/10 text-sm"
              >
                Làm Lại Đề Này
              </button>
              <button 
                onClick={() => setActiveTab('home')}
                className="bg-zinc-900 hover:bg-zinc-800 text-zinc-100 font-bold px-6 py-3 rounded-xl border border-zinc-800 transition-all text-sm"
              >
                Về Trang Chủ
              </button>
            </div>
